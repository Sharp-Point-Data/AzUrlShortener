...
{
    public static class ClickStatsWebhookAdd
    {
        [FunctionName("WebhookAdd")]
            ...
            ExecutionContext context)
        {
            ...
            WebhookRequest input = await req.Content.ReadAsAsync<WebhookRequest>();
            ...
            try
            {
                await stgHelper.SaveWebhookEntity(new WebhookEntity(input.Url));
            }
            catch (Exception ex)
            {
